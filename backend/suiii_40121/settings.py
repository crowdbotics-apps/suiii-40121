"""
Django settings for suiii_40121 project.
...
WSGI_APPLICATION = 'suiii_40121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "suiii_40121 API",
    "DESCRIPTION": "API documentation for suiii_40121 App",
    "VERSION": "v1",
}
